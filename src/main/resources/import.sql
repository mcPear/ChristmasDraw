...
INSERT INTO PUBLIC.MEMBERSHIP (ID, ABOUT, ACCEPTED, CHILDREN, INCLUDE_CHILDREN_IN_DRAW, INCLUDE_IN_DRAW, OWNS, DRAWN_USER_ID,
                               GROUP_ID, USER_ID)
VALUES
  (nextval('id_membership_seq'), NULL, TRUE, NULL, TRUE, TRUE, TRUE, NULL, 1, 1),
  (nextval('id_membership_seq'), NULL, TRUE, NULL, TRUE, TRUE, FALSE, NULL, 1, 2),
  (nextval('id_membership_seq'), NULL, NULL, NULL, TRUE, FALSE, FALSE, NULL, 1, 3),
  (nextval('id_membership_seq'), NULL, TRUE, NULL, TRUE, TRUE, FALSE, NULL, 1, 4),
  (nextval('id_membership_seq'), NULL, TRUE, NULL, TRUE, TRUE, FALSE, 2, 2, 1),
  (nextval('id_membership_seq'), NULL, TRUE, NULL, TRUE, TRUE, TRUE, 1, 2, 2),
  (nextval('id_membership_seq'), NULL, TRUE, NULL, TRUE, TRUE, FALSE, NULL, 1, 5);
